...
Why do you think this line is there? That line is the sql query. It is saying to select all the users from the users table. The reason it is there is because in the page we want to show all users.
